...
<% foreach(SimpleThemeView theme in ViewData.Model){ %>
    <dl>
	    ...
	    <dd class="themeCut"><a href="<%=theme.ThemeDetailUrl %>" title="<%=theme.Title %>"><img src="<%=theme.Thumbnail_112x168 %>" width="112" height="168" alt="<%=theme.Title %>" /></a><!--<span title="This is a 480x960(HD) iphone 4 theme" class="forIphone4">iPhone 4 Theme</span>--></dd>
