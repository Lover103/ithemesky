...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<title><%=ViewData.Model.CategoryId > 0 ? ViewData.Model.CategoryName.Replace("-", " & ") : "All Categories"%> iPhone 4 themes - <%=ViewData.Model.Sort%> - <!-- #include file="/Views/Inc/siteTitle.inc" --></title>
    <meta name="description" content="<%=ViewData.Model.CategoryId > 0 ? ViewData.Model.CategoryName.Replace("-", " & ") : "All Categories"%> iPhone 4 themes, <!-- #include file="/Views/Inc/siteDescription.inc" -->" />
	...
	<div id="main">
		...
		<div class="pageGuide">
			<ul class="breadcrumb">
				...
				<li><a href="/iphone4/new">iPhone 4 Categories</a></li>
				<% if (ViewData.Model.CategoryId > 0)
                   { %>
				<li><a href="/iphone4/new/<%=ViewData.Model.CategoryName%>_<%=ViewData.Model.CategoryId%>"><%=ViewData.Model.CategoryName.Replace("-", " & ")%></a></li>
				<% } %>
			</ul>
		</div>
		<!--breadcrumb end-->
