...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<title><%=ViewData.Model.CategoryId > 0 ? ViewData.Model.CategoryName.Replace("-", " & ") : "All"%> iPhone 4 themes - <%=ViewData.Model.Sort%> - <!-- #include file="/Views/Inc/siteTitle.inc" --></title>
    <meta name="description" content="<%=ViewData.Model.CategoryId > 0 ? ViewData.Model.CategoryName.Replace("-", " & ") : "All"%> iPhone 4 themes, <!-- #include file="/Views/Inc/siteDescription.inc" -->" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div id="main">
		...
		<div class="lists">
			...
			<% if (!ViewData.Model.ComeFromISpirit || true){ %>
